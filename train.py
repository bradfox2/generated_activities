...
type_ = IndependentCategorical.from_torchtext_field("type_", TYPE, rec_len)
subtype = IndependentCategorical.from_torchtext_field("subtype", SUBTYPE, rec_len)
lvl = IndependentCategorical.from_torchtext_field("lvl", LVL, rec_len)
respgroup = IndependentCategorical.from_torchtext_field("respgroup", RESPGROUP, rec_len)
